...
use commands::{
    ...
    marine::read_all_survey_cmd, marine::convert_tidal_datum_cmd,
    marine::create_backscatter_mosaic_cmd, marine::compute_qc_stats_cmd,
    marine::extract_water_column_summary_cmd,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            compute_volumes_cmd,
            compute_setout_cmd,
            mine_grid_to_crs_cmd,
            crs_to_mine_grid_cmd,
            analyze_tunnel_profile_cmd,
            generate_safety_report_cmd,
            ...
            read_all_survey_cmd,
            convert_tidal_datum_cmd,
            create_backscatter_mosaic_cmd,
            compute_qc_stats_cmd,
