...
return (
    <DialogShell
      ...
      maxWidth="max-w-2xl"
      subtitle="ZIP + ISO 19115 metadata"
      footerHint="Branded manifest"
      actions={
    ...
    >
          ...
          {step === 2 && (
            <div className="space-y-3">
              ...
              {sources.map((src, i) => (
                <div key={i} className="input-enterprise rounded-md border border-navy-border bg-navy-base p-3 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input type="text" value={src.path} onChange={(e) => updateSource(i, "path", e.target.value)}
                        ...
                        className="input-enterprise w-full rounded-md border border-navy-border bg-navy-base px-2 py-1.5 font-mono text-xs text-white focus:outline-none" />
                    </div>
                  </div>
                  {files.length > 0 && (
